...
def Btn2_Click():
	...
	subbutton1 = ttk.Button(
		...
		text = 'このページを閉じる',
		width = str('このページを閉じる'),
		command = sub_win2.destroy
		)
	subbutton1.place(x = 200, y = 150)
...
#ラベル作成
label1 = ttk.Label(text = 'ニュース紹介をするアプリです。気になるニュースにチェックを付けてください。', font = ('メイリオ', 15))
label1.pack()
label2 = ttk.Label(text = 'IT関係', font = ('メイリオ', 13))
label2.place(x = 100, y = 30)
label3 = ttk.Label(text = '化学関係', font = ('メイリオ', 13))
label3.place(x = 500, y = 30)
seplabel1 = ttk.Label(text = '-' * 80, font=("メイリオ", 13))
seplabel1.place(x = 100, y = 200)
label4 = ttk.Label(text = '意味を知りたい単語をここに入れてください!!', font = ('メイリオ', 15))
label4.place(x = 220, y = 220)
seplabel1 = ttk.Label(text = '-' * 65, font=("メイリオ", 13))
seplabel1.place(x = 160, y = 330)
label5 = ttk.Label(text = '文法ミス検出をしたい文を入力してください', font = ('メイリオ', 15))
